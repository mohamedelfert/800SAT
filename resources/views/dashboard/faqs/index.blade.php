                    ...
                    <div class="col-md-12">
                        <div class="card-header pb-0">
                            <div class="box-header with-border">
                                <span style="display: block;margin-bottom:10px">@lang('main.faqs') : <small>( {{ $faqs->total() }} )</small></span>
                                <form action="{{ route('dashboard.faqs.index') }}" method="get">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a class="btn btn-danger btn-sm" href="{{ route('dashboard.faqs.index') }}"
                                               title="@lang('main.clear')">
                                                <i class="fa fa-eraser"></i></a>
                                            @if(auth()->user()->hasPermissionTo('faq-create'))
                                                <a class="btn btn-primary btn-sm" href="{{ route('dashboard.faqs.create') }}"
                                    ...
                                    <table class="table mg-b-0 text-md-nowrap table-hover ">
                                        ...
                                        @foreach ($faqs as $index => $faq)
                                            <tr>
                                                ...
                                                <td>
                                                    @if(auth()->user()->hasPermissionTo('faq-show'))
                                                        <a class="btn btn-success btn-sm"
                                                           href="{{ route('dashboard.faqs.show', $faq->id) }}" title="@lang('main.show')">
                                                    ...
                                                    @if(auth()->user()->hasPermissionTo('faq-edit'))
                                                        <a class="btn btn-primary btn-sm"
                                                           href="{{ route('dashboard.faqs.edit', $faq->id) }}" title="@lang('main.edit')"><i
                                                    ...
                                                    @if(auth()->user()->hasPermissionTo('faq-delete'))
                                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                           data-toggle="modal" href="#delete{{ $faq->id }}" title="@lang('main.delete')">
                                            ...
                                            <div class="modal fade" id="delete{{ $faq->id }}">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content modal-content-demo">
                                                        ...
                                                        <form action="{{ route('dashboard.faqs.destroy','test') }}" method="post">
                                                            {{ method_field('delete') }}
                                                            {{ csrf_field() }}
