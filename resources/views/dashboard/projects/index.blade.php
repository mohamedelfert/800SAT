                    ...
                    <div class="col-md-12">
                        <div class="card-header pb-0">
                            <div class="box-header with-border">
                                <span style="display: block;margin-bottom:10px">@lang('main.projects') : <small>( {{ $projects->total() }} )</small></span>
                                <form action="{{ route('dashboard.projects.index') }}" method="get">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a class="btn btn-danger btn-sm" href="{{ route('dashboard.projects.index') }}"
                                               title="@lang('main.clear')">
                                                <i class="fa fa-eraser"></i></a>
                                            @if(auth()->user()->hasPermissionTo('project-create'))
                                                <a class="btn btn-primary btn-sm" href="{{ route('dashboard.projects.create') }}"
                                    ...
                                    <table class="table mg-b-0 text-md-nowrap table-hover ">
                                        ...
                                        @foreach ($projects as $index => $project)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ $project->image_path }}" class="img-thumbnail"
                                                           alt="@lang('main.image')" style="width:70px;">
                                                </td>
                                                <td>
                                                    @if(auth()->user()->hasPermissionTo('project-show'))
                                                        <a class="btn btn-success btn-sm"
                                                           href="{{ route('dashboard.projects.show', $project->id) }}" title="@lang('main.show')">
                                                    ...
                                                    @if(auth()->user()->hasPermissionTo('project-edit'))
                                                        <a class="btn btn-primary btn-sm"
                                                           href="{{ route('dashboard.projects.edit', $project->id) }}" title="@lang('main.edit')"><i
                                                    ...
                                                    @if(auth()->user()->hasPermissionTo('project-delete'))
                                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                           data-toggle="modal" href="#delete{{ $project->id }}" title="@lang('main.delete')">
                                            ...
                                            <div class="modal fade" id="delete{{ $project->id }}">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content modal-content-demo">
                                                        ...
                                                        <form action="{{ route('dashboard.projects.destroy','test') }}" method="post">
                                                            {{ method_field('delete') }}
                                                            {{ csrf_field() }}
