                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-lg-12 margin-tb">
                            <div class="pull-right">
                                <a class="btn btn-primary btn-sm" title="@lang('main.back')" href="{{ route('dashboard.projects.index') }}">
                        ...
                        <form method="POST" action="{{ route('dashboard.projects.update',$project->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="row mg-b-20">
                                <div class="parsley-input col-md-4" id="fnWrapper">
                                    ...
                                    <input class="form-control form-control-sm mg-b-20"
                                           ...
                                           name="title" value="{{ $project->title }}" type="text" required>
                                </div>

                                <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                    <label for="image">@lang('main.image')</label>
                                    <input class="form-control project_image" data-parsley-class-handler="#lnWrapper"
                            ...
                            <div class="row mg-b-20">
                                <div class="col">
                                    <label for="subtitle">@lang('main.subtitle')<span class="tx-danger">*</span></label>
                                    <input class="form-control form-control-sm mg-b-20"
                                           data-parsley-class-handler="#lnWrapper" id="subtitle"
                                           name="subtitle" value="{{ $project->subtitle }}" type="text" required>
                                </div>
                            </div>
                            ...
                            <div class="row row-sm mg-b-20">
                                <div class="col">
                                    ...
                                    <textarea class="form-control" id="content" name="content"
                                              rows="3" placeholder="Content">{{ $project->content }}</textarea>
                                </div>
                            </div>
