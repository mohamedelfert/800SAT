                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" id="2" data-toggle="dropdown"
                               aria-haspopup="true" aria-expanded="false">
                                <i class="font-22 fa fa-globe"></i>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown" style="height: 150px" aria-labelledby="2">
                                ...
                                <ul class="list-style-none">
                                    <li>
                                        <div class="drop-title text-white bg-danger">
                                            <h4 class="m-b-0 m-t-5">@lang('main.change_lang')</h4>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="message-center message-body">
                                            <a href="{{ LaravelLocalization::getLocalizedURL('ar') }}" class="dropdown-item d-flex ">
                                                <span class="avatar  ml-3 align-self-center bg-transparent">
                                                    <img src="{{ asset('dashboard/assets/flags/EG.png') }}" alt="img">
                                                </span>
                                                <div class="d-flex">
                                                    <span class="mt-2 ml-2">@lang('main.arabic')</span>
                                                </div>
                                            </a>
                                            <a href="{{ LaravelLocalization::getLocalizedURL('en') }}" class="dropdown-item d-flex ">
                                                <span class="avatar  ml-3 align-self-center bg-transparent">
                                                    <img src="{{ asset('dashboard/assets/flags/US.png') }}" alt="img">
                                                </span>
                                                <div class="d-flex">
                                                    <span class="mt-2 ml-2">@lang('main.english')</span>
                                                </div>
                                            </a>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="message-center message-body">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="{{ asset('dashboard/assets/images/users/1.jpg') }}" alt="user" class="rounded-circle">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="{{ asset('dashboard/assets/images/users/2.jpg') }}" alt="user" class="rounded-circle">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="{{ asset('dashboard/assets/images/users/3.jpg') }}" alt="user" class="rounded-circle">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
													<span class="user-img">
														<img src="{{ asset('dashboard/assets/images/users/4.jpg') }}" alt="user" class="rounded-circle">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="{{ auth()->user()->image_path }}" alt="user" class="rounded-circle" width="40">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        <img src="{{ auth()->user()->image_path }}" alt="user" class="rounded-circle" width="60">
                                    </div>
                                    <div class="m-l-10">
                                ...
                                <div class="profile-dis scrollable">
                                    <a class="dropdown-item" href="{{ route('dashboard.users.show',auth()->user()->id) }}">
                                        <i class="ti-user m-r-5 m-l-5"></i> @lang('main.profile')</a>
                                    <a class="dropdown-item" href="{{ route('dashboard.settings.index') }}">
                                        <i class="ti-settings m-r-5 m-l-5"></i> @lang('main.settings')</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                        <i class="fa fa-power-off m-r-5 m-l-5"></i>@lang('main.logout')</a>
